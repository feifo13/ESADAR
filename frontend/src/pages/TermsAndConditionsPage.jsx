...
const sections = [
  {
    ...
    copy: "ESADAR comercializa prendas seleccionadas, en su mayoría de segunda mano. Cada artículo puede presentar señales propias de uso, antigüedad o conservación, las cuales se informan en la publicación cuando corresponde.",
  },
  {
    title: "2. Disponibilidad y stock",
    copy: "El stock es limitado y generalmente unitario. La publicación de un artículo no garantiza disponibilidad permanente. Si una prenda queda agotada, reservada o inactiva, ESADAR puede impedir la compra y mostrar alternativas relacionadas.",
  },
  {
    title: "3. Precios, ofertas y promociones",
    copy: "Los precios se expresan en pesos uruguayos salvo indicación contraria. Algunas prendas pueden aceptar ofertas. La aceptación de una oferta queda sujeta a aprobación de ESADAR y puede tener vigencia limitada.",
  },
  {
    title: "4. Órdenes y reserva",
    copy: "Al confirmar una compra, la orden queda registrada y puede permanecer pendiente de validación manual. Las prendas asociadas a la orden se reservan por 24 horas. Si el pago no se completa o no se puede validar dentro de ese plazo, ESADAR puede cancelar la orden.",
  },
  {
  ...
  },
  {
    ...
    copy: "La aprobación de una orden depende de la validación del pago. Una vez aprobada, ESADAR enviará el correo de confirmación correspondiente y el comprobante de compra en PDF.",
  },
  {
    title: "7. Envíos",
  ...
  },
  {
    ...
    copy: "Por tratarse de prendas seleccionadas y muchas veces únicas, los cambios o devoluciones se evaluarán caso a caso. El cliente debe revisar fotos, medidas, estado y descripción antes de confirmar la compra.",
  },
  {
    title: "9. Datos de contacto",
    copy: "Para consultas sobre órdenes, pagos, envíos o condiciones particulares, el cliente puede comunicarse con ESADAR desde la vista de contacto.",
  },
];
