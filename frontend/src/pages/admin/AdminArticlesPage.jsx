...
export default function AdminArticlesPage() {
  ...
  async function loadArticles(query = '') {
    try {
      ...
      setError(err.message || 'No se pudo cargar articulos');
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="container page-stack admin-page-shell">
      ...
      <section className="section-card page-stack">
        ...
        <div className="toolbar-inline">
          <input className="input" placeholder="Buscar articulo" value={search} onChange={(event) => setSearch(event.target.value)} />
