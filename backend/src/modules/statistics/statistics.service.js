...
import { DEFAULT_BANK_TAX_RATE } from '../articles/article-pricing-calculator.js';
import {
...
const ORDER_ITEM_BANK_TAX_RATE_EXPR = `COALESCE(oi.bank_tax_rate_snapshot, ${DEFAULT_BANK_TAX_RATE})`;
