  ...
  () => {
    ...
    assert.deepEqual(
      validDiagnostic,
      {
        ...
        rawRequestIdPresent: true,
        requestIdTrimChanged: false,
        requestIdTruncated: false,
        bodyDataIdPresent: false,
        bodyDataIdMatchesQuery: false,
        hmacRawRequestIdMatches: true,
        hmacCleanUnslicedRequestIdMatches: true,
        hmacBodyDataIdMatches: false,
    ...
    assert.deepEqual(
      invalidDiagnostic,
      {
        ...
        rawRequestIdPresent: false,
        requestIdTrimChanged: false,
        requestIdTruncated: false,
        bodyDataIdPresent: false,
        bodyDataIdMatchesQuery: false,
        hmacRawRequestIdMatches: false,
        hmacCleanUnslicedRequestIdMatches: false,
        hmacBodyDataIdMatches: false,
        hmacWithoutRequestIdMatches: false,
      },
    );
